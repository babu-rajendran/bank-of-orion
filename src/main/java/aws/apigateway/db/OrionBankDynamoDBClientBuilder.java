...
public final class OrionBankDynamoDBClientBuilder
		extends SdkSyncClientBuilder<OrionBankDynamoDBClientBuilder, OrionBankDynamoDB> {

	private static final URI DEFAULT_ENDPOINT = RuntimeHttpUtils.toUri("yujv25jhgl.execute-api.us-east-1.amazonaws.com",
			Protocol.HTTPS);
	private static final String DEFAULT_REGION = "us-east-1";

	/**
	 * Package private constructor - builder should be created via
	 * {@link OrionBankDynamoDB#builder()}
	 */
	...
	/**
	 * Construct a synchronous implementation of OrionBankDynamoDB using the current

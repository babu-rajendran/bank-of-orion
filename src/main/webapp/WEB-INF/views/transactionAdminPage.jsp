			...
			<div class="row">
								...
								<tr>
									<td colspan="2">
										<p class="pb-1 mb-0 small lh-sm">
											<strong class="d-block text-gray-dark">Account
												Number</strong>
										</p>
									</td>
								</tr>
				...
				<div class="col-md-6">
					<table class="styled-table">
						<tr>
							<td><strong class="d-block text-gray-dark">Approve
									Transaction</strong></td>
							<td><form:form method="POST"
									action="${pageContext.request.contextPath}/approveTransaction"
									modelAttribute="acctMangForm" cssClass="container-fluid">
									&nbsp;
									...
									<c:if test="${transaction.transactionStatus != 'Pending'}">
										<input type="submit"
											...
											style="width: 75px;" value="Approve" />
									</c:if>
									<c:if test="${transaction.transactionStatus == 'Pending'}">
										<input type="submit" class="btn btn-primary submit btn-sm"
											style="width: 75px;" value="Approve" />
						...
						<tr>
							<td><strong class="d-block text-gray-dark">Cancel
									Transaction</strong></td>
							<td><form:form method="POST"
									action="${pageContext.request.contextPath}/cancelTransactionAdmin"
									modelAttribute="acctMangForm" cssClass="container-fluid">
									&nbsp;
									<form:hidden path="transactionId"
										value="${transaction.transactionID}" />

	...
	<div class="wrapper">
		...
		<header>
			<nav class="website-nav">
				<ul>
					<li><a class="home-link"
						href="${pageContext.request.contextPath}">Home</a></li>
					<li><a href="${pageContext.request.contextPath}/signInPage">Sign
							In </a></li>
					<li><a href="${pageContext.request.contextPath}/signUpPage">Sign
							Up </a></li>
				</ul>
			</nav>
		</header>
		...
		<div class="message">
			...
			<div class="text">
				<h1>Greetings!</h1>
				<h2>Welcome to Bank of Orion</h2>
			</div>
		</div>
	</div>
